...
// ══════════════════════════════════════════════════════════
// ── NÓMINAS (resumen semanal + cierre + descuentos) ──────
// ══════════════════════════════════════════════════════════
...
async function loadDescuentos() {
    // Cargar selects (motorizados + categorías) y la lista de la semana
...
async function registrarDescuento(e) {
    ...
    if (res && !res.error) {
        ...
        loadDescuentos();
        loadNominasContable(); // refrescar columna Daños del resumen
    } else {
